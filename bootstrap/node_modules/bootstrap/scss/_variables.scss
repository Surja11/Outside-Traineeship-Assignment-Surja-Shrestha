...
$border-radius:               1.5625rem !default;
...
$headings-line-height:        0.94 !default;
...
$input-btn-padding-y:         .5rem !default; //changed to reflect the padding-y required in design
$input-btn-padding-x:         1.25rem !default;//changed to reflect padding-x required in design
